  ...
  private initializeData() {
    ...
    this.digitalLibraryCategories = [
      ...
      },
      {
        ...
        description: "Các loại hình nghệ thuật biểu diễn truyền thống của Huế",
        descriptionEn: "Traditional performing arts of Hue",
        parentId: null,
        iconUrl: null,
        type: "performing_arts",
        sortOrder: "2"
      ...
      {
        id: this.getNextId(),
        name: "Ẩm thực và thủ công",
        nameEn: "Culinary and Crafts",
        description: "Ẩm thực và các nghề thủ công truyền thống của Huế",
        descriptionEn: "Traditional cuisine and crafts of Hue",
        parentId: null,
        iconUrl: null,
        type: "culinary_crafts",
        sortOrder: "3"
      }
    ];
