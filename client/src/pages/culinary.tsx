...
const hueDishes = [
  {
    ...
    description: "Món bún bò Huế là một trong những đặc sản nổi tiếng của xứ Huế. Nước dùng được nấu từ xương bò và giò heo trong nhiều giờ, kết hợp với sả, gừng và các gia vị đặc trưng của Huế.",
    descriptionEn: "Bun bo Hue is one of the most famous specialties of Hue. The broth is cooked from beef bones and pork knuckles for many hours, combined with lemongrass, ginger and Hue's characteristic spices.",
    image: "https://placehold.co/600x400/EEE/31343C?text=B%C3%BAn+b%C3%B2+Hu%E1%BA%BF",
    type: "main_dish",
  ...
  },
  {
    ...
    description: "Bánh khoái là một món ăn đặc sản của Huế, gần giống với bánh xèo nhưng kích thước nhỏ hơn và cách chế biến cũng khác.",
    descriptionEn: "Bánh khoái is a specialty of Hue, similar to bánh xèo but smaller in size and prepared differently.",
  ...
  },
  {
    ...
    name: "Cơm hến",
    nameEn: "Clam Rice",
    description: "Cơm hến là món ăn dân dã đặc trưng của Huế, được làm từ cơm trộn với hến, rau thơm và nhiều gia vị.",
    descriptionEn: "Com hen is a rustic dish characteristic of Hue, made from rice mixed with baby clams, herbs and many spices.",
  ...
  },
  {
    ...
    description: "Bánh bèo là món bánh truyền thống của Huế, có hình dáng giống như lá bèo nổi trên mặt nước.",
    descriptionEn: "Banh beo is a traditional Hue cake, shaped like a water fern leaf floating on the water.",
  ...
  },
  {
    ...
    description: "Chè Huế nổi tiếng với nhiều loại khác nhau, từ chè khoai tím, chè bắp đến chè sen. Mỗi loại đều có hương vị đặc trưng và cách chế biến riêng.",
    descriptionEn: "Hue sweet soups are famous with many different types, from purple sweet potato, corn to lotus seed. Each has its own distinctive flavor and preparation method.",
  ...
  },
  {
    ...
    description: "Bánh lọc là món bánh trong suốt làm từ bột sắn hoặc bột năng, nhân tôm thịt, được gói trong lá chuối và hấp chín.",
    descriptionEn: "Banh loc is a transparent cake made from cassava flour or tapioca starch, filled with shrimp and pork, wrapped in banana leaves and steamed.",
  ...
  return (
    <Card className="hover-translate overflow-hidden">
      ...
      <CardContent className="p-4">
        ...
        <CardDescription className="text-xs mb-2 text-muted-foreground">{dish.nameEn}</CardDescription>
            ...
            {dish.places.map((place, index) => (
              <div key={index} className="mb-3 last:mb-0">
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs ml-1 text-muted-foreground">{place.rating}/5</span>
                </div>
                {index < dish.places.length - 1 && <Separator className="mt-3" />}
              </div>
            ))}
          </div>
      ...
      <div className="bg-card rounded-lg overflow-hidden">
        <div className="relative h-64 md:h-80">
          ...
          <div className="absolute bottom-4 left-4 right-4 text-white">
            ...
            <p className="text-sm opacity-90">Hành trình phát triển của nền ẩm thực tinh tế</p>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm">
              Ẩm thực cung đình Huế được hình thành và phát triển qua nhiều triều đại của các vua nhà Nguyễn. Đây là nền ẩm thực mang tính chất hoàng gia, được chế biến công phu và cầu kỳ bởi các đầu bếp cung đình tài năng nhằm phục vụ vua chúa và hoàng tộc.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Đặc trưng của ẩm thực cung đình Huế là sự cân bằng giữa hương - vị - sắc - hình, thể hiện triết lý âm dương hài hòa. Mỗi món ăn đều được đầu tư về mặt thẩm mỹ, từ cách cắt thái nguyên liệu đến việc trình bày đẹp mắt.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Nhiều món ăn ngày nay như bánh bèo, bánh nậm, bánh bột lọc, chè Huế... đều có nguồn gốc từ cung đình và sau đó được phổ biến rộng rãi trong dân gian.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm">
              Song song với ẩm thực cung đình, ẩm thực dân gian Huế cũng phát triển với những nét đặc trưng riêng. Đây là nền ẩm thực mộc mạc, gần gũi, sử dụng nguyên liệu sẵn có trong tự nhiên và mang đậm bản sắc văn hóa địa phương.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Các món ăn dân gian Huế thường đơn giản nhưng không kém phần tinh tế, như cơm hến, bún thịt nướng, bánh canh, cháo lươn... Đặc biệt, người Huế có xu hướng sử dụng nhiều gia vị cay nồng như ớt, tiêu, gừng để tạo nên hương vị đặc trưng.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Sự giao thoa giữa ẩm thực cung đình và dân gian đã tạo nên nền ẩm thực Huế phong phú, đa dạng và độc đáo như ngày nay.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Ẩm thực Huế không chỉ dừng lại ở việc chế biến món ăn mà còn là cả một nghệ thuật thưởng thức. Người Huế coi trọng không gian, thời gian và cách thức thưởng thức ẩm thực.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Nhiều món ăn Huế được thiết kế với kích thước nhỏ nhắn, hương vị đậm đà, yêu cầu người ăn phải từ tốn thưởng thức để cảm nhận hết hương vị. Đây cũng là phản ánh của tính cách người Huế - nhẹ nhàng, tinh tế và sâu sắc.
            </p>
            <p className="text-muted-foreground text-sm mt-2">
              Ngày nay, ẩm thực Huế không chỉ là niềm tự hào của người dân xứ Huế mà còn trở thành một phần quan trọng trong nền ẩm thực Việt Nam, thu hút sự quan tâm của du khách trong và ngoài nước.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 border border-border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground mb-2">Khu vực tập trung nhiều quán ăn truyền thống với các món đặc sản Huế.</p>
                <Badge variant="outline" className="mr-2 mb-2">Bánh bèo</Badge>
                <Badge variant="outline" className="mr-2 mb-2">Bánh nậm</Badge>
              ...
              <div className="p-4 border border-border rounded-lg">
                ...
                <Badge variant="outline" className="mr-2 mb-2">Bún bò Huế</Badge>
              ...
              <div className="p-4 border border-border rounded-lg">
                ...
                <Badge variant="outline" className="mr-2 mb-2">Bánh ép</Badge>
                <Badge variant="outline" className="mr-2 mb-2">Bún thịt nướng</Badge>
              ...
              <div className="p-4 border border-border rounded-lg">
                ...
                <Badge variant="outline" className="mr-2 mb-2">Cơm hến</Badge>
                <Badge variant="outline" className="mr-2 mb-2">Canh cá rô</Badge>
